...
Here, the operator $$a_{n}^{\dagger}$$ and $$a_{n}$$ create and annihilate a deuteron in the harmonic-oscillator *s*-wave state $$|n\rangle$$. We map this operator $$a_{n}^{\dagger}$$ and $$a_{n}$$ onto qubits using Jordan-Wigner transformation. We work with $$N=2$$. So the Hamiltonian written as 
